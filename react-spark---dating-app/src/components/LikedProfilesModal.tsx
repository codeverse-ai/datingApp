...
export const LikedProfilesModal: React.FC<LikedProfilesModalProps> = ({ profiles, onClose, navigate }) => {
        ...
        >
            ...
            >
                <div className="flex-shrink-0 flex justify-between items-center p-4 border-b border-slate-200">
                    <h2 className="text-xl font-bold text-slate-800">People You've Liked</h2>
