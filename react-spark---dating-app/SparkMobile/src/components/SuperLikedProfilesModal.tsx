...
export const SuperLikedProfilesModal: React.FC<SuperLikedProfilesModalProps> = ({ profiles, onClose, visible }) => {
    ...
    return (
        ...
        >
            <LinearGradient colors={['#E0F2FE', '#F0F9FF']} style={styles.container}>
                <SafeAreaView style={styles.flex}>
                    <View style={styles.header}>
                        <Text style={styles.title}>Your Super Likes</Text>
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            <TouchableOpacity style={styles.profileCard} onPress={() => handleProfileClick(item.id)}>
                                ...
                                <View style={styles.starIconContainer}>
                                    <StarIcon width={24} height={24} color="#facc15" />
                                </View>
                        ...
                        ListEmptyComponent={
                            <View style={styles.emptyContainer}>
                                <Text style={styles.emptyText}>You haven't Super Liked anyone yet!</Text>
                            </View>
                        }
                    />
                </SafeAreaView>
