...
export const PREDEFINED_LOCATIONS: NamedLocation[] = [
  ...
  { name: 'Mumbai', location: { lat: 19.0760, lon: 72.8777 } },
  { name: 'Delhi', location: { lat: 28.7041, lon: 77.1025 } },
  { name: 'Kolkata', location: { lat: 22.5726, lon: 88.3639 } },
];
...
export const MOCK_PROFILES: Profile[] = [
  {
    ...
    photos: ['https://picsum.photos/seed/jessica/800/1200', 'https://picsum.photos/seed/jessica2/800/1200'],
  ...
  },
  {
    ...
    photos: ['https://picsum.photos/seed/alex/800/1200', 'https://picsum.photos/seed/alex2/800/1200', 'https://picsum.photos/seed/alex3/800/1200'],
  ...
  },
  {
    ...
    photos: ['https://picsum.photos/seed/chloe/800/1200', 'https://picsum.photos/seed/chloe2/800/1200'],
  ...
  },
  {
    ...
    photos: ['https://picsum.photos/seed/marcus/800/1200', 'https://picsum.photos/seed/marcus2/800/1200'],
  ...
  },
  {
    ...
    photos: ['https://picsum.photos/seed/sophia/800/1200', 'https://picsum.photos/seed/sophia2/800/1200', 'https://picsum.photos/seed/sophia3/800/1200'],
  ...
  },
  {
    ...
    photos: ['https://picsum.photos/seed/liam/800/1200', 'https://picsum.photos/seed/liam2/800/1200'],
  ...
  },
  {
    ...
    bio: '',
    photos: ['https://picsum.photos/seed/aria/800/1200'],
  ...
  },
  {
    ...
    photos: ['https://picsum.photos/seed/leo/800/1200', 'https://picsum.photos/seed/leo2/800/1200'],
  ...
  },
  {
    ...
    photos: ['https://picsum.photos/seed/maya/800/1200', 'https://picsum.photos/seed/maya2/800/1200'],
  ...
  },
  {
    ...
    photos: ['https://picsum.photos/seed/finn/800/1200'],
  ...
  },
  {
    ...
    bio: 'Techie with a love for spicy food and Bollywood movies. Looking for someone to explore Bangalore\'s food scene with.',
    photos: ['https://picsum.photos/seed/priya/800/1200'],
    location: { lat: 12.9716, lon: 77.5946 }, // Bangalore
    gender: 'Woman',
    interests: ['Technology', 'Movies', 'Cooking', 'Foodies'],
    orientation: ['Straight'],
    vibe: VIBES[1],
    zodiac: ZODIAC_SIGNS[2],
  },
  {
    id: '12',
    name: 'Rohan',
    ...
    bio: 'Building the next big thing in tech. When I\'m not working, I\'m probably hiking or planning my next trip.',
    photos: ['https://picsum.photos/seed/rohan/800/1200'],
    location: { lat: 12.9716, lon: 77.5946 }, // Bangalore
    gender: 'Man',
    interests: ['Startups', 'Technology', 'Hiking', 'Travel', 'Travelers'],
    orientation: ['Straight'],
    vibe: VIBES[0],
    zodiac: ZODIAC_SIGNS[8],
  },
  ...Array.from({ length: 50 }, (_, i) => {
    ...
    const name = `${gender === 'Woman' ? 'Woman' : 'Man'} ${i + 1}`;
    return {
      id: `dummy-${i + 1}`,
      name,
      age: 25 + (i % 10),
      pronouns: gender === 'Woman' ? 'she/her' : 'he/him',
      occupation: 'Developer',
      bio: `This is a dummy bio for ${name}.`,
      photos: [`https://picsum.photos/seed/dummy-${i + 1}/800/1200`],
      location: { lat: 12.9716, lon: 77.5946 }, // Bangalore
      gender: gender as 'Woman' | 'Man',
      interests: ['Technology', 'Movies', 'Cooking'],
      orientation: ['Straight'],
      vibe: VIBES[i % 5],
      zodiac: ZODIAC_SIGNS[i % 12],
    };
  })
];
...
export let MOCK_USERS: User[] = [
    {
      ...
      photos: ['https://picsum.photos/seed/chris/800/1200'],
      ...
      superLikedProfiles: [MOCK_PROFILES.find(p => p.id === '3')!, MOCK_PROFILES.find(p => p.id === '8')!],
      vibe: VIBES[0],
